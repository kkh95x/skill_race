...
class SavedProfilesComponents extends ConsumerWidget {
  const SavedProfilesComponents({super.key});
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    ...
    controller.addListener(() {
      if(controller.position.pixels==controller.position.maxScrollExtent) {
        ref.read(paginationArchivedProjectProvider(ArchivesType.user).notifier).fetchNextBatch();
      }
     });
...
physics: const AlwaysScrollableScrollPhysics(),
      child: Container(
        ...
        child: Column(
          children: [
            ref.watch(paginationArchivedProjectProvider(ArchivesType.user)).when(data: (recipes) {
                     ...
                     child: Container(
                      padding: EdgeInsets.symmetric(horizontal: 12.w,vertical: 13.h),
                       child: ListTile(
                        ...
                        title: ProfilePicNameSpcialWidget(userId: recipes[index].refrenceId),
                                  ...
                                  Row(
                                    children: [
                                      DynamicButton(
                                        ...
                                        title: "Yes",
                                        onPressed: () async{
                                         await ref.read(deleteArchivedProvider(recipes[index]).future).then((value) {
                                          context.pop();
