...
final homePagePagination=StateNotifierProvider<PaginationNotifier<PostProject>,PaginationState<PostProject>>(
  (ref) =>PaginationNotifier(getSnapshoots: (limit) {
    return  ref.read(postProjectRepositoryProvider).getAll(limit);
