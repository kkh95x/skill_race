            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  DynamicInput(placeholder: "",autoFoucs: false,control: "companyName",title: "Company Name",),
                  SizedBox(height: 16.h,),
                  DynamicInput(placeholder: "",autoFoucs: false,control: "companyField",title: "Company Field",),
                  ...
                  ReactiveFormConsumer(
                    builder: (context, formGroup, child) {
                    bool isOpen;
                    final interst=needEmpForm.control("specialization").value as String?;
                    List<String>? supList;
                    if(interst!=null){
                ...
                DynamicInput(placeholder: "",autoFoucs: false,control: "numberOfEmployees",title: "Number Of Employees",type: Type.number,),
                    SizedBox(height: 20.h,),

                DynamicInput(placeholder: "",autoFoucs: false,control: "typeOfTravelVisa",title: "Type Of Travel Visa",),
SizedBox(height: 20.h,),

                DynamicInput(placeholder: "",autoFoucs: false,control: "workingHours",title: "Working Hours",type: Type.number,),
        SizedBox(height: 20.h,),

                DynamicInput(placeholder: "",autoFoucs: false,control: "salary",title: "Salary",type: Type.number,),    

                 SizedBox(height: 20.h,),

                DynamicInput(placeholder: "",autoFoucs: false,control: "durationOfTheContract",title: "Duration of the contract",),            
                                 SizedBox(height: 20.h,),


                DynamicInput(placeholder: "",autoFoucs: false,control: "weekends",title: "Weekends",),     
                 SizedBox(height: 20.h,),


                DynamicInput(placeholder: "",autoFoucs: false,control: "age",title: "Age",), 
                 SizedBox(height: 20.h,),
